...
SETLOCAL
SET PROJECT_DIR=%cd%
SET PROJECT_NAME=recreation-data
SET SUPPORT_LIBRARY = rec_data
SET ENV_NAME=rec-data
...
:build_upload
    ENDLOCAL & (
        ...
        :: Build conda package
        CALL conda build ./conda-recipe --output-folder ./conda-recipe/conda-build
        CALL anaconda upload ./conda-recipe/conda-build/win-64/recreation-data*.tar.bz2
